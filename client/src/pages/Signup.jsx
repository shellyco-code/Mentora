...
const Signup = () => {
  ...
  const { signup, loginWithGoogle, demoMode } = useAuth()
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setError(demoMode ? 'Demo mode: any credentials work.' : 'Failed to create account. Email may already be in use.')
    } finally {
      setLoading(false)
    }
  }
    ...
    <div className="min-h-screen bg-black flex items-center justify-center px-4">
      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="card border-gray-800">
          ...
          <p className="text-gray-500 text-sm mb-6">Start your AI-powered career journey</p>
